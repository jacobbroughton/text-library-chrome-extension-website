      ...
      <div>
        ...
        <div className="privacy-policy-container">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Note Library, accessible from{" "}
                <a
                  href="https://note-library-dcoo.onrender.com/privacy"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://note-library-dcoo.onrender.com/privacy
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              <a
                href="https://note-library-dcoo.onrender.com/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://note-library-dcoo.onrender.com/contact
              </a>
            </li>
          </ul>
        </div>
